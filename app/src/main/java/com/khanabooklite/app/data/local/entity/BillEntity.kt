...
data class BillEntity(
    ...
    val id: Int = 0,
    @ColumnInfo(name = "daily_order_id")
    val dailyOrderId: Int,
    @ColumnInfo(name = "daily_order_display")
    val dailyOrderDisplay: String, // "27022026-001"
    @ColumnInfo(name = "lifetime_order_id")
    val lifetimeOrderId: Int, // never resets
    ...
    @ColumnInfo(name = "cgst_amount", defaultValue = "0.0")
    val cgstAmount: Double = 0.0,
    @ColumnInfo(name = "sgst_amount", defaultValue = "0.0")
    ...
    val paymentMode: String, // cash | upi | pos | zomato | swiggy | own_website | part_cash_upi | ...
    @ColumnInfo(name = "part_amount_1", defaultValue = "0.0")
    val partAmount1: Double = 0.0,
    @ColumnInfo(name = "part_amount_2", defaultValue = "0.0")
    val partAmount2: Double = 0.0,
